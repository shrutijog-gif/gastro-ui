...
export const documents: Document[] = [
    ...
    ...Array.from({ length: 11 }).map((_, i) => ({
        id: `DOC-2026-00009${i + 1}`,
        version: `Ver 1.${i + 1}`,
        date: 'Feb 28, 2026',
        title: `BB Brand Guide SOP${i + 2}`,
        description: `BB SOP${i + 2}`,
        category: 'Brand Guidelines',
        type: 'Brand Guide',
        department: 'Operations',
        documentTypeId: 'ops-bb-guidelines',
    ...
    ...Array.from({ length: 120 }).map((_, i) => ({
        ...
        version: `Ver 1.0`,
        date: 'Feb 28, 2026',
        title: `KIT BB SOP ${i + 2}`,
        description: `Kitchen checklist`,
        category: 'Brand Guidelines',
        type: 'Checklists',
        department: 'Kitchen',
        documentTypeId: 'kit-bb-guidelines',
    ...
    },
    {
        ...
        description: 'InfoSec guidelines',
        category: 'IT Policies',
        type: 'Company Policies',
        department: 'Technology',
        documentTypeId: 'tech-corp-policies',
